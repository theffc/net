...
class Vertice(object):
    ...
    def __init__(self, Grafo, nome=None):
    ...
    def mostrar(self):
        ...
        print((self.nome if self.nome else self.iID), end=', ')
...
class Aresta(object):
    ...
    def mostrar(self):
        # print ( str(self.iID)+ ' - ' + str(self.Rect) , ',', '')
        print("(", self.t[0].nome, '-', self.t[1].nome, ')')
...
class Grafo(object):
    ...
    def __init__(self):
        ...
        self.antigoRect = None  # usado apenas para printar a bolinha cinza quando o usuario estiver mudando um vertice
        #                           de lugar
    ...
    def busca_profundidade(self, v):
        ...
        for x in v.lAdjs:
            if x.iID not in self.setVisited:
    ...
    def get_vertice(self, name_id):
        for v in self.lVertices:
            if name_id == (v.nome or v.iID):
                return v
        # end Grafo
